...
**Do not stop after reading this skill.** Execute every phase to completion or a terminal state. Questions phases are conditional gates — pause for user input but auto-fallback if unattended; all other phases run without gates.
